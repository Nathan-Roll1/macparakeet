...
The Microphone step stays in onboarding, but Continue is no longer gated on grant. Dictation and mic-backed meetings already request access on first use. Idle launch prewarm is skipped when the mic is not granted. Accessibility remains required.
