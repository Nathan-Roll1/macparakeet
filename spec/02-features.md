...
- The menu bar **Transforms** submenu runs a saved Transform on the selection captured when the status menu opened (before MacParakeet became frontmost). Hide individual Transforms from that submenu via the card context menu; missing preference shows every visible Transform.
