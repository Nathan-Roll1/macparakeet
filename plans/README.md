...
|------|-------|--------|----------|-------------|
| [2026-09-16-issue-1062-apple-intelligence](active/2026-09-16-issue-1062-apple-intelligence.md) | Apple Intelligence on-device LLM provider (#1062) | **REVIEW** | P2 | Provider seam, Settings tile, CLI, focused tests, live Tahoe availability+tokenCount A/B. Generation A/B skipped until Apple Intelligence is enabled. |
